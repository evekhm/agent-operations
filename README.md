...
When running the default `overview` playbook, the script orchestrates a pipeline of advanced analytical queries and AI-augmented insights to produce a highly structured, data-backed Markdown report. Key capabilities mirror the exact sections generated in the final output:
