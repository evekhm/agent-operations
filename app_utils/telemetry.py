...
def configure_otel_tracing(project_id: str) -> None:
    ...
    # We add the exporter to the global tracer provider (which is auto-configured or a proxy).

    # Check if we have a real provider or need to set one
    provider = trace.get_tracer_provider()
    # ProxyTracerProvider is the default if SDK is not initialized
    ...
    print("OpenTelemetry Cloud Trace Exporter configured.")
