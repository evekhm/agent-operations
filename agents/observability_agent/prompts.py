...
*   **Fatal Timeout/Crash Recognition**: If any error log explicitly states "PENDING for >" and "(Timed Out)", explicitly identify it as a silent system crash or unhandled code exception, NOT a normal concurrency delay.
