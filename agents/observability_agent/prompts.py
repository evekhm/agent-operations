...
*   **Summary Paragraph:** Beneath the tables, write a brief summary analyzing possible correlations identified between latency and *generated output tokens*. Specifically list out which models/agents expose strong correlation behaviors.
...
*   **IDs & Entities:** You MUST wrap all Session IDs, Agent Names, Tool Names, and Model Names in backticks (e.g., `bigquery_agent`, `gemini-1.5-pro`) in ALL narrative text paragraphs.
